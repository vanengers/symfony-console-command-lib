...
class HelloWorldCommandFileExistsValidatorWithDefaultFile extends AbstractConsoleCommand
{
    public string $name = '';
    public int $age = 0;
    ...
    public function getOptions()
    {
        return [
            ...
            new Option('config', 'name param', 'string', __DIR__.'/HelloWorldCommandFileExistsValidatorWithDefaultFile.php', true, null, [
